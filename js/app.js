...
let slider_pick = new Swiper('.pick__slider', {
...
let slider_watch = new Swiper('.watch__slider', {
	/*
	effect: 'fade',
	*/
	autoplay: {
...
//========================================================================================================================================================
// Прокрутка при клике
const goLinks = document.querySelectorAll('[data-goto]');
if (goLinks.length > 0) {
...
// вызов модального окна через какое-то время
